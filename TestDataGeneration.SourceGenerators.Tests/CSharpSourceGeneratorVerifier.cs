...
namespace TestDataGeneration.SourceGenerators.Tests
{
    ...
    //Copied and edited, can be removed when "Microsoft.CodeAnalysis.CSharp.Testing" version is available
            ...
            where TVerifier : IVerifier, new()
    {
        ...
        /// </summary>
        /// <param name="document">The <see cref="System.Reflection.Metadata.Document"/> to be converted to a string.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> that the task will observe.</param>
        /// <returns>A <see cref="SourceText"/> containing the syntax of the <see cref="System.Reflection.Metadata.Document"/> after formatting.</returns>
        ...
        where TVerifier : IVerifier, new()
    {
        ...
        protected override GeneratorDriver CreateGeneratorDriver(Project project, ImmutableArray<IIncrementalGenerator> sourceGenerators)
        {
            return CSharpGeneratorDriver.Create(
                sourceGenerators.Select(x => x.AsSourceGenerator()),
